  ...
  <div class="modal">
      ...
      <div class="item-body">橙色预警:
        ...
        <Input
          ...
          placeholder="正整数"
          class="setting-input"
          v-model="dashBoardRedev.warnning"
        />最大值:
      ...
      <div class="item-body">橙色预警:
        <Input
          ...
          placeholder="正整数"
          class="setting-input"
          v-model="dashBoard48Hour.action"
        />红色预警:
        <Input
          type="text"
          placeholder="正整数"
          class="setting-input"
          v-model="dashBoard48Hour.warnning"
        />最大值:
      ...
      <div class="item-body">橙色预警:
        <Input
          ...
          placeholder="正整数"
          class="setting-input"
          v-model="dashBoard24Hour.action"
        />红色预警:
        <Input
          type="text"
          placeholder="正整数"
          class="setting-input"
          v-model="dashBoard24Hour.warnning"
        />最大值:
